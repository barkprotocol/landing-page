...
import { TOKEN_PROGRAM_ID, ASSOCIATED_TOKEN_PROGRAM_ID, MEMO_PROGRAM_ID, MILTON_MINT_ADDRESS, USDC_TOKEN_ADDRESS } from '@/lib/solana/programs'
    ...
    for (const ix of instructions) {
      if ('parsed' in ix) {
        if (ix.program === 'system' && ix.parsed.type === 'transfer') {
          ...
          } else if (ix.parsed.info.mint === MILTON_MINT_ADDRESS.toBase58()) {
