...
const verifySignature = async (request: NextRequest): Promise<boolean> => {
...
const getUserFromToken = async (authToken: string) => {
...
export async function POST(request: NextRequest) {
  try {
    ...
    const referrer = await getUserFromToken(authToken);
