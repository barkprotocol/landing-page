...
import { AlertCircle, ArrowLeft, Zap, Gift, Image as ImageIcon, Heart, Send, FileText, Users, Loader2, Info, Check, Calendar, CreditCard, Repeat, Sparkles } from 'lucide-react'
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <TabsContent value="payment" className="space-y-4">
                        <Card>
                          <CardHeader>
                            ...
                            <CardDescription>Set up your payment Blink</CardDescription>
                          </CardHeader>
                      ...
                      <TabsContent value="subscription" className="space-y-4">
                        <Card>
                          <CardHeader>
                            ...
                            <CardDescription>Set up your subscription Blink</CardDescription>
                          </CardHeader>
                          <CardContent className="space-y-4">
                            <div className="space-y-2">
                      ...
                      {/* Add similar TabsContent for other Blink types */}
                    </motion.div>
                  </AnimatePresence>
          ...
          <div className="py-4">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="details">
                <AccordionTrigger>Blink Details</AccordionTrigger>
                <AccordionContent>
